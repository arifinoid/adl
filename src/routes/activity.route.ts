...
export const activityRoutes = new Elysia({ prefix: "/activities" })
    ...
    .get("/", ActivityController.list, { query: ActivityQuerySchema })
    .get("/:id", ActivityController.getDetail, { params: ActivityParamsSchema })
    .post("/", ActivityController.create, { body: CreateActivitySchema })
    .patch("/:id", ActivityController.update, {
        params: ActivityParamsSchema,
        body: UpdateActivitySchema
    })
    .delete("/:id", ActivityController.delete, { params: ActivityParamsSchema });
